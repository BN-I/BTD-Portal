...
const iconStyle: Record<string, string> = {
  Dashboard: "bg-brand-50 text-brand-600",
...
export function SidebarContent({ onNavigate }: SidebarContentProps) {
  ...
  return (
    <>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-gradient-to-r from-brand-500/12 to-brand-400/5 text-brand-700 shadow-[inset_0_0_0_1px_rgba(255,58,68,0.2)]"
            ...
            >
              <span
                className={cn(
                  ...
                  isActive ? "bg-brand-100 text-brand-600" : ic,
                )}
              >
      ...
      {/* Footer badge */}
      <div className="mx-3 px-4 py-3 rounded-xl bg-gradient-to-br from-brand-50 to-brand-100/50 border border-brand-100/80">
        <p className="text-[11px] font-semibold text-brand-700">Vendor Portal</p>
        <p className="text-[10px] text-brand-500 mt-0.5">Manage your store</p>
      </div>
    </>
  );
}
